              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: Theme.of(context).textTheme.bodyText1,
                    validator: (value) =>
                        value!.length < 6 ? AppLocalizations.of(context).translate("loginTxtErrorPassword") : null,
                    decoration: InputDecoration(
                        prefixIcon: Icon(
                          Icons.lock,
                          color: Theme.of(context).iconTheme.color,
                ...
                authProvider.status == Status.authenticating ? const Center(
                ...
                authProvider.status == Status.authenticating ? const Center(
                    ...
                    : Padding(
                        ...
                        child: Center(
                            child: Text(
                          AppLocalizations.of(context).translate("loginTxtDontHaveAccount"),
                          style: Theme.of(context).textTheme.button,
                        )),
                      ),
                authProvider.status == Status.authenticating
                    ...
                    : TextButton(
                        child: Text(AppLocalizations.of(context).translate("loginBtnLinkCreateAccount")),
                ...
                Center(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      Provider.of<Flavour>(context).toString(),
